...
public class StoreAPI: APIBase {
     ...
     */
    public class func deleteOrder(orderId orderId: Int64, completion: ((error: ErrorType?) -> Void)) {
     ...
     */
    public class func deleteOrderWithRequestBuilder(orderId orderId: Int64) -> RequestBuilder<Void> {
